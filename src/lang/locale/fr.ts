...
export default {
    // flashcard-modal.tsx
    DECKS: "Paquets",
    DUE_CARDS: "Cartes à faire",
    NEW_CARDS: "Nouvelles Cartes",
    TOTAL_CARDS: "Cartes Totales",
    EDIT_LATER: "Modifier Plus Tard",
    RESET_CARD_PROGRESS: "Remettre le Progrés de la Carte",
    HARD: "Difficile",
    GOOD: "Bon",
    EASY: "Facile",
    SHOW_ANSWER: "Montrer Réponse",
    CARD_PROGRESS_RESET: "Le progrés de cette carte avait été remettre.",//"Card's progress has been reset.",
    ...
    // scheduling.ts
    DAYS_STR_IVL: "${interval} journée(s)",
    ...
    // settings.ts
    SETTINGS_HEADER: "Spaced Repetition Plugin - Paramétres",
